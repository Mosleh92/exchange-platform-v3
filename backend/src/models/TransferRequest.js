...
transferRequestSchema.methods.addToHistory = function(action, details, performedBy) {
  this.history.push({
    action,
    details,
    performedBy
...
transferRequestSchema.methods.addStatusHistory = function(status, changedBy, reason = '', notes = '') {
...
transferRequestSchema.methods.complete = function(processedBy, processingNotes = '') {
  ...
  this.addStatusHistory('completed', processedBy, 'Transfer completed', processingNotes);
