...
vipCustomerSchema.methods.updateStatistics = function (transactionAmount) {
  ...
  this.statistics.averageTransactionSize =
    this.statistics.totalVolume / this.statistics.totalTransactions;
  this.statistics.lastTransactionDate = new Date();
  return this.save();
};

// Method to add history
vipCustomerSchema.methods.addHistory = function (
  field,
  oldValue,
  newValue,
  changedBy,
...
vipCustomerSchema.methods.checkTransactionLimit = function (_amount) {
  // amount marked as unused
