...
p2pChatSchema.methods.addMessage = function (
  senderTenantId,
  senderUserId,
  content,
  type = "text",
...
// Method to add offer
p2pChatSchema.methods.addOffer = function (
  fromTenantId,
  fromUserId,
  amount,
  rate,
...
p2pChatSchema.methods.respondToOffer = function (
  offerId,
  response,
  responderTenantId,
  responderUserId,
...
p2pChatSchema.methods.markMessageAsRead = function (
  messageIndex,
  readerTenantId,
) {
...
p2pChatSchema.methods.updateParticipantStatus = function (
  tenantId,
  userId,
  isOnline,
) {
