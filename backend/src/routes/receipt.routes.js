...
router.post('/generate', receiptValidation, receiptController.generateAndSendReceipt);
...
router.post('/bulk-generate', receiptController.generateReceiptsForExistingTransactions);
