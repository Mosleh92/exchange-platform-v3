...
router.put(
  "/:id/verify",
  auth,
  authorize("manager", "staff", "tenant_admin", "super_admin"),
  validate,
  cryptoOrderController.verifyOrder,
);
...
router.put(
  ...
  authorize("manager", "staff", "tenant_admin", "super_admin"),
  validate,
  cryptoOrderController.settleOrder,
);
...
router.post(
  ...
  authorize("manager", "staff", "tenant_admin", "super_admin"),
  validate,
  cryptoOrderController.createInPersonOrder,
);
...
router.put(
  ...
  auth,
  authorize("manager", "staff", "tenant_admin", "super_admin"),
  cryptoOrderController.markCashPaid,
);
// علامت‌گذاری دریافت نقدی (برای فروش)
router.put(
  "/:id/mark-cash-received",
  auth,
  authorize("manager", "staff", "tenant_admin", "super_admin"),
  cryptoOrderController.markCashReceived,
);
...
router.put(
  ...
  cryptoOrderController.markVerified,
);
...
router.get(
  ...
  auth,
  authorize("tenant_admin", "super_admin"),
  cryptoOrderController.reportOrders,
);
...
router.get(
  ...
  auth,
  authorize("tenant_admin", "super_admin"),
  cryptoOrderController.pendingAlerts,
);
