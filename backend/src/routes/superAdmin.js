...
router.post(
  "/tenants/:tenantId/extend-subscription",
  superAdminController.extendSubscription,
);
router.post(
  "/tenants/:tenantId/reset-password",
  superAdminController.resetTenantAdminPassword,
);

// Plan management
router.post(
  "/tenants/:tenantId/assign-plan",
  superAdminController.assignTenantPlan,
);
router.post(
  "/tenants/:tenantId/suspend-plan",
  superAdminController.suspendTenantPlan,
);
router.post(
  "/tenants/:tenantId/expire-plan",
  superAdminController.expireTenantPlan,
);
