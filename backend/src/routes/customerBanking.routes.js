...
router.post('/transfer-requests', transferRequestValidation, customerBankingController.createTransferRequest);

// Get customer's transfer requests
router.get('/transfer-requests', customerBankingController.getCustomerTransferRequests);

// Get specific transfer request
router.get('/transfer-requests/:requestId', customerBankingController.getTransferRequestById);

// Cancel transfer request
router.put('/transfer-requests/:requestId/cancel', customerBankingController.cancelTransferRequest);
...
router.post('/admin/accounts', createAccountValidation, customerBankingController.createCustomerAccount);

// Process transfer request
router.put('/admin/transfer-requests/:requestId/process', customerBankingController.processTransferRequest);
