...
router.post('/', auth, authorize('super_admin'), InvoiceController.createInvoice);
...
router.post('/mark-paid', auth, authorize('super_admin', 'tenant_admin'), InvoiceController.markAsPaid);
