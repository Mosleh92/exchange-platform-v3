...
router.post(
  ...
  interBranchTransferController.createTransfer,
);
...
router.post(
  "/:transferId/approve",
  interBranchTransferController.approveTransfer,
);

// Reject transfer
router.post(
  "/:transferId/reject",
  interBranchTransferController.rejectTransfer,
);

// Verify transfer
router.post(
  "/:transferId/verify",
  interBranchTransferController.verifyTransfer,
);

// Complete transfer
router.post(
  "/:transferId/complete",
  interBranchTransferController.completeTransfer,
);

// Cancel transfer
router.post(
  "/:transferId/cancel",
  interBranchTransferController.cancelTransfer,
);
...
router.get(
  "/status/:status",
  interBranchTransferController.getTransfersByStatus,
);
