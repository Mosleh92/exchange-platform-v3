...
const userValidation = {
  create: [
    ...
    body("role")
      .isIn(["super_admin", "tenant_admin", "manager", "staff", "customer"])
...
const transactionValidation = {
  create: [
    ...
    body("currency")
      .isIn(["USD", "EUR", "AED", "IRR", "GBP", "BTC", "ETH", "USDT"])
...
const cryptoWalletValidation = {
  create: [
    ...
    body("currency")
      .isIn(["BTC", "ETH", "USDT"])
      .withMessage("ارز دیجیتال نامعتبر است"),
    body("address")
      .isString()
      .isLength({ min: 10 })
      .withMessage("آدرس کیف پول نامعتبر است"),
  ],
};
...
const bankAccountValidation = {
  create: [
    ...
    body("bankName")
      ...
      .withMessage("نام بانک نامعتبر است"),
    body("accountHolder")
      .isString()
      .isLength({ min: 2, max: 100 })
      .withMessage("نام صاحب حساب نامعتبر است"),
  ],
};
...
const validateDebt = [
  ...
  body("originalAmount")
    .isFloat({ min: 0.01 })
    .withMessage("مبلغ اصلی باید عدد مثبت باشد"),
  body("currency")
    .isIn(["IRR", "USD", "EUR", "AED", "GBP", "TRY"])
    .withMessage("ارز نامعتبر است"),
  body("dueDate").isISO8601().withMessage("تاریخ سررسید نامعتبر است"),
  body("interestRate")
    .optional()
    .isFloat({ min: 0, max: 100 })
    .withMessage("نرخ بهره باید بین 0 تا 100 باشد"),
  body("penaltyRate")
    .optional()
    .isFloat({ min: 0, max: 100 })
    .withMessage("نرخ جریمه باید بین 0 تا 100 باشد"),
  body("gracePeriod")
    .optional()
    .isInt({ min: 0 })
    .withMessage("دوره ارفاق باید عدد صحیح مثبت باشد"),
];
