...
const commonRules = {
  ...
  date: body("date").isISO8601().withMessage("تاریخ نامعتبر است"),

  id: param("id").isMongoId().withMessage("شناسه نامعتبر است"),
};
...
const userRules = {
  create: [
    ...
    body("permissions.*").isString().withMessage("هر دسترسی باید رشته باشد"),
  ],
...
exports.validateCurrencyTransaction = [
  ...
  body("delivery.method")
    ...
    .withMessage(
      "delivery.method must be one of: bank_transfer, cash_pickup, account_credit",
    ),
  ...
  body("delivery.bankAccount.accountNumber")
    ...
    .isLength({ min: 5, max: 50 })
    .withMessage(
      "bankAccount.accountNumber must be between 5 and 50 characters",
    ),
  ...
  body("delivery.bankAccount.accountHolder")
    ...
    .isLength({ min: 2, max: 100 })
    .withMessage(
      "bankAccount.accountHolder must be between 2 and 100 characters",
    ),
  ...
  body("delivery.pickupLocation.address")
    ...
    .withMessage(
      "pickupLocation.address must be between 10 and 200 characters",
    ),
