...
class ValidationRules {
    ...
    static registerValidation() {
        return [
            ...
            body('role')
                .isIn(['customer', 'staff', 'branchManager', 'tenantAdmin', 'superAdmin'])
    ...
    static tenantValidation() {
        return [
            body('name')
                .notEmpty()
                .withMessage('نام صرافی الزامی است'),
    ...
    static branchValidation() {
        return [
            body('name')
                .notEmpty()
                .withMessage('نام شعبه الزامی است'),
            
            body('code')
                .notEmpty()
                .withMessage('کد شعبه الزامی است'),
            
            body('address')
                .notEmpty()
                .withMessage('آدرس شعبه الزامی است'),
            
            body('phone')
                .notEmpty()
                .withMessage('شماره تلفن شعبه الزامی است')
        ];
    }
    ...
    static debtValidation() {
        return [
            ...
            body('dueDate')
                .isISO8601()
                .withMessage('تاریخ سررسید معتبر نیست'),
