...
describe('Security: Tenant Isolation & RBAC', () => {
  ...
  beforeAll(async () => {
    ...
    customer1 = await Customer.create({ name: 'Ali', phone: '+989111111111', tenant_id: admin1.tenantId });
    customer2 = await Customer.create({ name: 'Sara', phone: '+989122222222', tenant_id: admin2.tenantId });
