...
const token1 = jwt.sign(
  { _id: user1, tenantId: tenant1, branchId: branch1, role: "tenant_admin" },
  "testsecret",
);
const token2 = jwt.sign(
  { _id: user2, tenantId: tenant2, branchId: branch2, role: "tenant_admin" },
  "testsecret",
);
...
const tokenSuperAdmin = jwt.sign(
  { _id: new mongoose.Types.ObjectId(), role: "super_admin" },
  "testsecret",
);
