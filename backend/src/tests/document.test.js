...
const tokenOther = jwt.sign({ _id: new mongoose.Types.ObjectId(), tenantId: new mongoose.Types.ObjectId(), branchId: new mongoose.Types.ObjectId(), role: 'tenant_admin' }, 'testsecret');
