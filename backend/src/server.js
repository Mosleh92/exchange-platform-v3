...
class ExchangePlatformServer {
  ...
  setupTenantRoutes() {
    ...
    // Get current tenant
    tenantRouter.get("/current", partnerController.getCurrentTenant);
  ...
  setupRatesRoutes() {
    ...
    // Get rate by ID
    rateRouter.get("/:rateId", rateController.getRateById);
    ...
    // Get live rates
    rateRouter.get("/live/current", rateController.getLiveRates);
  ...
  setupPaymentRoutes() {
    ...
    // Upload receipt
    paymentRouter.post("/:paymentId/receipt", paymentController.uploadReceipt);
    ...
    paymentRouter.get("/stats/summary", paymentController.getPaymentStats);

    // Get pending payments
    paymentRouter.get("/pending/list", paymentController.getPendingPayments);
  ...
  setupDebtRoutes() {
    ...
    // Get debt by ID
    debtRouter.get("/:debtId", debtController.getDebtById);
    ...
    // Add payment to debt
    debtRouter.post("/:debtId/payment", debtController.addPayment);
    ...
    // Get overdue debts
    debtRouter.get("/overdue/list", debtController.getOverdueDebts);

    // Get debt statistics
    debtRouter.get("/stats/summary", debtController.getDebtStats);
  ...
  setupExchangeAccountRoutes() {
    ...
    // Get all accounts
    accountRouter.get("/", accountRouter.getAllAccounts);
    ...
    // Get account by ID
    accountRouter.get("/:accountId", accountRouter.getAccountById);
    ...
    // Deposit to account
    accountRouter.post("/:accountId/deposit", accountRouter.deposit);

    // Withdraw from account
    accountRouter.post("/:accountId/withdraw", accountRouter.withdraw);
    ...
    accountRouter.get("/stats/summary", accountRouter.getAccountStats);
  ...
  setupInterBranchTransferRoutes() {
    ...
    // Get all transfers
    transferRouter.get("/", transferRouter.getAllTransfers);
    ...
    // Get transfer by ID
    transferRouter.get("/:transferId", transferRouter.getTransferById);
    ...
    // Verify transfer
    transferRouter.post("/:transferId/verify", transferRouter.verifyTransfer);
    ...
    transferRouter.get("/pending/list", transferRouter.getPendingTransfers);

    // Get transfers by status
    transferRouter.get("/status/:status", transferRouter.getTransfersByStatus);

    // Get transfer statistics
    transferRouter.get("/stats/summary", transferRouter.getTransferStats);
